...
public static class GoKitTweenExtensions
{
    ...
    public static GoTween colorTo ( this Material self , float duration , Color endValue )
    {
        return Go.to( self , duration , new GoTweenConfig().materialColor( endValue ) );
    }

    public static GoTween colorFrom ( this Material self , float duration , Color endValue )
    {
        return Go.from( self , duration , new GoTweenConfig().materialColor( endValue ) );
    }

    #endregion Material extensions
}