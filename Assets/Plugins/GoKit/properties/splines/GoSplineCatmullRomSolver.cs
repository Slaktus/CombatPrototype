...
public class GoSplineCatmullRomSolver : AbstractGoSplineSolver
{
    ...
    public override void closePath ()
    {
        ...
        float distanceToFirstNode = Vector3.Distance( _nodes[0], _nodes[1] );
        float distanceToLastNode = Vector3.Distance( _nodes[0], _nodes[_nodes.Count - 2] );
        ...
        float distanceToFirstTarget = distanceToLastNode / Vector3.Distance( _nodes[1], _nodes[0] );
        Vector3 lastControlNode = ( _nodes[0] + ( _nodes[1] - _nodes[0] ) * distanceToFirstTarget );
        ...
        float distanceToLastTarget = distanceToFirstNode / Vector3.Distance( _nodes[_nodes.Count - 2], _nodes[0] );
        Vector3 firstControlNode = ( _nodes[0] + ( _nodes[_nodes.Count - 2] - _nodes[0] ) * distanceToLastTarget );
    ...
    public override Vector3 getPoint ( float t )
    {
        ...
        //Debug.Log( "t: " + t + " NumSections: " + numSections + " CurrentNode: " + currentNode );
    ...
    #endregion AbstractGoSplineSolver
}