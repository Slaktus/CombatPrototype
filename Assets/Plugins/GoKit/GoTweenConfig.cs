...
public class GoTweenConfig
{
    ...
    /// </summary>
    public GoTweenConfig materialColor ( Color endValue , bool isRelative = false )
    {
        var prop = new MaterialColorTweenProperty( endValue, isRelative );
        _tweenProperties.Add( prop );
    ...
    #endregion TweenProperty adders
